  ...
  return (
    <div className="w-full h-full flex flex-col bg-white rounded-2xl border border-pink-100 
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto mb-2 space-y-3 xs:space-y-4 xs:max-h-[65vh]
                       pink-scrollbar">
        ...
        <div className="bg-white text-pink-500 rounded-xl p-3 xs:p-4
                       shadow-[0_6px_16px_rgba(236,72,153,0.1),inset_0_1px_2px_rgba(255,255,255,0.8)]
                       border border-pink-100 mt-2">
