...
const ChatRoom = ({ showWishlist, setShowWishlist }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white rounded-2xl border border-amber-100 
                    ...
                    max-[425px]:w-[calc(100%-16px)] max-[425px]:mx-auto
                    max-[420px]:w-[calc(100%-14px)]
                    max-[415px]:w-[calc(100%-12px)]
                    max-[410px]:w-[calc(100%-10px)]
                    max-[405px]:w-[calc(100%-8px)]
                    max-[401px]:w-[calc(100%-6px)]
      ...
      <div className="flex items-center justify-between px-3 xs:px-4 sm:px-6 py-3 xs:py-4 border-b border-amber-100 
                     ...
                     max-[425px]:px-3 max-[425px]:py-3
                     max-[415px]:px-2.5 max-[415px]:py-2.5
                     max-[405px]:px-2 max-[405px]:py-2
        ...
        <div className="flex items-center gap-2 xs:gap-3 sm:gap-4 
          ...
          <div className="relative">
            <div className="w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 rounded-2xl 
                           ...
                           max-[425px]:w-9 max-[425px]:h-9 max-[425px]:text-base
                           max-[415px]:w-8 max-[415px]:h-8 max-[415px]:text-sm
                           max-[405px]:w-8 max-[405px]:h-8 max-[405px]:text-sm
            ...
            <div className="absolute -bottom-1 -right-1 w-3 h-3 xs:w-4 xs:h-4 sm:w-5 sm:h-5 
                           ...
                           max-[425px]:w-2.5 max-[425px]:h-2.5
                           max-[415px]:w-2 max-[415px]:h-2 max-[415px]:-bottom-0.5 max-[415px]:-right-0.5
                           max-[405px]:w-2 max-[405px]:h-2 max-[405px]:-bottom-0.5 max-[405px]:-right-0.5
                           max-[400px]:w-2.5 max-[400px]:h-2.5
                           max-[380px]:w-2 max-[380px]:h-2 max-[380px]:-bottom-0.5 max-[380px]:-right-0.5"></div>
          </div>
          
          <div className="max-[425px]:flex-1 max-[425px]:min-w-0
                         max-[415px]:flex-1 max-[415px]:min-w-0 max-[415px]:mr-1
                         max-[405px]:flex-1 max-[405px]:min-w-0 max-[405px]:mr-1
            ...
            <h1 className="text-base xs:text-lg sm:text-xl font-bold text-gray-900 
                          ...
                          max-[425px]:text-sm max-[425px]:truncate
                          max-[415px]:text-xs max-[415px]:truncate max-[415px]:leading-4
                          max-[405px]:text-xs max-[405px]:truncate max-[405px]:leading-4
                          max-[400px]:text-sm max-[400px]:truncate
                          max-[380px]:text-xs max-[380px]:leading-tight">
              Live Chat Room
            </h1>
            <p className="text-xs text-green-600 font-medium flex items-center gap-1
                         max-[425px]:text-[10px] max-[425px]:mt-0.5
                         max-[415px]:text-[9px] max-[415px]:mt-0 max-[415px]:gap-0.5
                         max-[405px]:text-[9px] max-[405px]:mt-0 max-[405px]:gap-0.5
              ...
              <span className="w-1.5 h-1.5 xs:w-2 xs:h-2 bg-green-500 rounded-full animate-pulse 
                              ...
                              max-[425px]:w-1.5 max-[425px]:h-1.5
                              max-[415px]:w-1 max-[415px]:h-1
                              max-[405px]:w-1 max-[405px]:h-1
        ...
        <button 
          ...
          className="p-2 xs:p-3 rounded-xl bg-gradient-to-r from-amber-600 to-amber-700 
                     ...
                     max-[425px]:p-2 max-[425px]:min-w-[36px] max-[425px]:h-9
                     max-[415px]:p-1.5 max-[415px]:min-w-[32px] max-[415px]:h-8
                     max-[405px]:p-1.5 max-[405px]:min-w-[30px] max-[405px]:h-8
      ...
      <div className="flex-1 p-3 xs:p-4 sm:p-6 overflow-y-auto space-y-3 xs:space-y-4 sm:space-y-6 
                     ...
                     max-[425px]:p-3 max-[425px]:space-y-3
                     max-[415px]:p-2.5 max-[415px]:space-y-2.5
                     max-[405px]:p-2 max-[405px]:space-y-2
        ...
        <div className="flex items-start gap-2 xs:gap-3 sm:gap-4 transform transition-transform
          ...
          <div className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 rounded-2xl 
                         ...
                         max-[415px]:w-6 max-[415px]:h-6
                         max-[405px]:w-6 max-[405px]:h-6
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-gray-600 mb-1 
                         max-[425px]:text-[10px] max-[425px]:mb-0.5
                         max-[415px]:text-[9px] max-[415px]:mb-0
                         max-[405px]:text-[9px] max-[405px]:mb-0
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-800 
                           ...
                           max-[425px]:max-w-[90%] max-[425px]:px-2 max-[425px]:py-1.5
                           max-[415px]:max-w-[92%] max-[415px]:px-1.5 max-[415px]:py-1
                           max-[405px]:max-w-[94%] max-[405px]:px-1.5 max-[405px]:py-1
              ...
              <p className="text-xs xs:text-sm sm:text-base 
                           max-[425px]:text-xs max-[425px]:leading-tight
                           max-[415px]:text-[11px] max-[415px]:leading-tight
                           max-[405px]:text-[11px] max-[405px]:leading-tight
      ...
      <div className="p-2 xs:p-3 sm:p-4 border-t border-amber-100 bg-white rounded-b-2xl
        ...
        <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 
                       ...
                       max-[425px]:gap-1.5 max-[425px]:p-1.5
                       max-[415px]:gap-1 max-[415px]:p-1
                       max-[405px]:gap-1 max-[405px]:p-1
          ...
          <button 
            ...
            className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex items-center justify-center 
                       ...
                       max-[415px]:w-7 max-[415px]:h-7
                       max-[405px]:w-7 max-[405px]:h-7
                       max-[400px]:w-7 max-[400px]:h-7
                       max-[380px]:w-6 max-[380px]:h-6 max-[380px]:rounded-lg"
          >
          ...
          <input
            ...
            className="flex-1 px-2 xs:px-3 sm:px-4 py-1.5 xs:py-2 sm:py-3 bg-transparent 
                       ...
                       max-[425px]:px-2 max-[425px]:py-1.5 max-[425px]:text-xs
                       max-[415px]:px-1.5 max-[415px]:py-1 max-[415px]:text-[11px]
                       max-[405px]:px-1.5 max-[405px]:py-1 max-[405px]:text-[11px]
        ...
        <p className="text-[10px] xs:text-xs text-gray-500 text-center mt-3 xs:mt-2
                     ...
                     max-[425px]:text-[10px] max-[425px]:mt-2
                     max-[415px]:text-[9px] max-[415px]:mt-1.5
                     max-[405px]:text-[9px] max-[405px]:mt-1.5
