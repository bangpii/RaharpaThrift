  ...
  return (
    ...
    >
      ...
      <h2
        ...
        max-[450px]:text-3xl transform transition-transform hover:scale-105"
      >
       Raharpa <span className="text-pink-500">Thrift</span>
      </h2>

      {/* Navigation Buttons */}
      <div className="flex items-center gap-3 max-[422px]:justify-center">
        {/* Home Button */}
        <button
        ...
        >
          <i className="bx bx-home text-xl text-pink-500"></i>
          Home
        </button>
