...
const ChatRoom = ({ showWishlist, setShowWishlist }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white rounded-2xl border border-amber-100 
      ...
      {/* Efek 3D Border */}
      <div className="absolute inset-0 rounded-2xl border-2 border-white/50 pointer-events-none max-[380px]:rounded-xl"></div>
      ...
      <div className="flex items-center justify-between px-3 xs:px-4 sm:px-6 py-3 xs:py-4 border-b border-amber-100 
        ...
        <div className="flex items-center gap-2 xs:gap-3 sm:gap-4 max-[400px]:gap-2 max-[380px]:gap-1.5">
          {/* Profile 3D Effect */}
          ...
          <div className="max-[400px]:flex-1 max-[400px]:min-w-0 max-[380px]:min-w-0 max-[380px]:flex-1">
        ...
        >
          <i className="bx bx-heart text-base xs:text-lg sm:text-xl max-[400px]:text-sm max-[380px]:text-xs"></i>
        </button>
      </div>
      ...
      <div className="flex-1 p-3 xs:p-4 sm:p-6 overflow-y-auto space-y-3 xs:space-y-4 sm:space-y-6 
        ...
        <div className="flex items-start gap-2 xs:gap-3 sm:gap-4 transform transition-transform
          ...
          <div className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 rounded-2xl 
            ...
            <i className="bx bx-user text-xs xs:text-sm sm:text-base max-[400px]:text-xs max-[380px]:text-[10px]"></i>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-gray-600 mb-1 max-[400px]:text-[10px] max-[400px]:mb-0.5 max-[380px]:text-[9px] max-[380px]:mb-0">Admin • 09:12</p>
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-800 
              ...
              <p className="text-xs xs:text-sm sm:text-base max-[400px]:text-xs max-[400px]:leading-tight max-[380px]:text-[11px] max-[380px]:leading-tight">
        ...
        <div className="flex items-start justify-end gap-2 xs:gap-3 sm:gap-4 transform transition-transform
          ...
          <div className="flex-1 min-w-0 text-right">
            <p className="text-xs font-semibold text-gray-600 mb-1 max-[400px]:text-[10px] max-[400px]:mb-0.5 max-[380px]:text-[9px] max-[380px]:mb-0">You • 09:13</p>
        ...
        <div className="flex items-start gap-2 xs:gap-3 sm:gap-4 transform transition-transform
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-gray-600 mb-1 max-[400px]:text-[10px] max-[400px]:mb-0.5 max-[380px]:text-[9px] max-[380px]:mb-0">Admin • 09:14</p>
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-800 
                           px-2 py-1.5 xs:px-3 xs:py-2 sm:px-4 sm:py-3 rounded-2xl rounded-tl-none 
                           shadow-[0_4px_12px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,0.8)]
                           border border-gray-200 transform transition-all duration-300 
        ...
        <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 
          ...
          <button 
            ...
            className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex items-center justify-center 
                       ...
                       max-[380px]:w-6 max-[380px]:h-6 max-[380px]:rounded-lg"
          >
            <i className="bx bx-plus text-lg xs:text-xl sm:text-2xl max-[400px]:text-sm max-[380px]:text-xs"></i>
          </button>
          ...
          <button className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex items-center justify-center 
                            ...
                            max-[400px]:w-7 max-[400px]:h-7
                            max-[380px]:w-6 max-[380px]:h-6 max-[380px]:rounded-lg">
            <i className="bx bx-send text-sm xs:text-lg sm:text-xl max-[400px]:text-xs max-[380px]:text-[10px]"></i>
          </button>
        </div>
